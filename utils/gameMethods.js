...
let risk_matrix = [
  ...
  [0.253975, 0.3021, 0.334249, 0.359174, 0.379781, 0.397492, 0.413109, 0.427133, 0.439897],
  ...
  [0.595894, 0.599129, 0.601, 0.602382, 0.603433, 0.604294, 0.605022, 0.605653, 0.606211],
  [0.6941, 0.696876, 0.69798, 0.698765, 0.699375, 0.699873, 0.700294, 0.70066, 0.700982],
  [0.796088, 0.797167, 0.797798, 0.798246, 0.798594, 0.798879, 0.799119, 0.799328, 0.799512],
  [0.898112, 0.898721, 0.899076, 0.899329, 0.899525, 0.899685, 0.899821, 0.899938, 0,9001],
];
...
function criteria_Laplasa() {
  ...
  for (let j = 0; j < solution; j++) {
    for (let i = 0; i < external_condition; i++) {
      summ += benefit_matrix[i][j] / external_condition;
    }
    average_marks[j] = summ;
    summ = 0;
    if (average_marks[j] > max) {
